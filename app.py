...
# --- TEXTO INTRODUTÓRIO ---
st.markdown("""
Este aplicativo visa demonstrar o uso dos três algoritmos de pesquisa estudados neste semestre em nosso curso de Algoritmos e Estrutura de Dados II e avaliar o tempo de resposta de cada um deles.
* Pesquisa Sequencial, 
* Pesquisa Indexada,
